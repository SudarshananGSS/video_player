    ...
    return (
      <div className="mb-8 rounded-lg border border-neutral-200 bg-neutral-50 p-4">
        ...
        <p className="mt-1 text-sm text-neutral-600">
          AR {arNumber} · These links never change, even if you replace your campaign video, so they can be reused
          across welcome emails and other campaigns. Give them to your Zoho admin once to set up email templates.
        </p>
